pageextension 14304313 COPurchaseOrderSubform extends "Purchase Order Subform"
{
    layout
    {
        modify(Quantity)
                        ...
                        if Location."BOM to PO" then
                            if Item.Get(Rec."No.") then
                                if Item."Production BOM No." <> '' then begin
                                    ...
                                    NewPurchLine.SetRange("PO BOM", true);
                                    ...
                                    if ProdBOMLine.FindSet() then
                                        repeat
                                            ...
                                            NewPurchLine."PO BOM" := true;
                                            NewPurchLine.Modify();
                                            if Location."Balance Charge Item" <> '' then begin
                                                LineNo += 100;
                                                NewCIPurchLine.Init();
                                                ...
                                                NewCIPurchLine.Validate("No.", Location."Balance Charge Item");
                                                ...
                                                NewCIPurchLine."PO BOM" := true;
                                                NewCIPurchLine.Modify();
                                                CreateItemChageAssign(NewCIPurchLine);
    ...
    procedure CreateItemChageAssign(PurchLine: Record "Purchase Line")
    var
