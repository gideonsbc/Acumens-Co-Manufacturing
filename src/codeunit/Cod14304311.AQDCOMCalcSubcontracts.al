codeunit 14304311 "AQD COM Calc-Subcontracts"
{
    trigger OnRun()
    var
    ...
    begin
        ManSetup.get();
        ManSetup.TestField("AQD Subcon Template Name");
        ManSetup.TestField("AQD Subc. Batch Name");
    ...
    begin
        ...
        RequisitionLine."Worksheet Template Name" := ManSetup."AQD Subcon Template Name";
        RequisitionLine."Journal Batch Name" := ManSetup."AQD Subc. Batch Name";
