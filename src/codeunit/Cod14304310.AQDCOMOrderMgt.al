codeunit 14304310 "AQD COM Order Mgt"
{
    procedure AssignLotNoToProdOrderLine(var ProdOrderLine: Record "Prod. Order Line"; LotNo: Code[50]): Code[50]
    var
    ...
    begin
        ...
        if LotNo = '' then
            ReservationEntry.Validate("Lot No.", NoSeriesManagement.GetNextNo(Item."Lot Nos.", Today(), true))
        else
    ...
    begin
        ...
        if FromProdOrderComponent.FindSet() then
            repeat
                ToProdOrderComponent.Init();
    ...
    begin
        ...
        if FromProdOrderRoutingLine.FindSet() then
            repeat
                ToProdOrderRoutingLine.Init();
                ...
                if CoManHeader.Get(ProdOrder."AQD Co-Man No.") then begin
                    ...
                    if ResEntry.FindSet() then
                        repeat
                            ...
                            ResEntry.Modify();
                            ResEntry.UpdateItemTracking();
                        until ResEntry.Next() = 0;
                    TranHeader."AQD Co-Man No." := CoManHeader."No.";
                    TranHeader.Modify();
    ...
    begin
        ...
        if not (Location."Require Shipment" or TLocation."Require Shipment") then
    ...
    begin
        ...
        //TransferLine."WHI Transfer Origin" := TransferLine."WHI Transfer Origin"::" "; //SBC 
        TransferLine.Insert();
    end;
    ...
    var
        ...
        CalcSubcontracts: Codeunit "AQD COM Calc-Subcontracts";
    ...
    begin
        ...
        ProdOrder."AQD Co-Man No." := CoManNo;
        ...
        //ProdOrder."Prod. Unit Of Measure" := ItemProductioUOM; //Field does not exists. <<<SBC 2026-02-12
        ...
        if PurchLine.FindSet() then
            repeat
                Clear(SKU);
                if SKU.Get(ProdOrder."Location Code", PurchLine."No.", '') then
                    if SKU."AQD WIP Item" <> '' then begin
                        ...
                        NewPurchLine.SetRange("No.", SKU."AQD WIP Item");
                        if NewPurchLine.IsEmpty then begin
                            ...
                            NewPurchLine.Validate("No.", SKU."AQD WIP Item");
                            ProdOrderComponent.SetRange("Prod. Order No.", ProdOrder."No.");
                            ProdOrderComponent.SetRange("Item No.", SKU."AQD WIP Item");
        ...
        case ProdOrder."Source Type" of
            ProdOrder."Source Type"::Item:
                begin
                    ...
                    //ProdOrderLine.Validate("Unit of Measure Code", ProdOrder."Prod. Unit Of Measure"); //Field does not exists. <<<SBC 2026-02-12
