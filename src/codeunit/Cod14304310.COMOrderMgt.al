                ...
                if CoManHeader.Get(ProdOrder."Co-Man No.") then begin
                    ...
                    repeat
                        ...
                        if ConItemLedgerEntry.FindSet() then
                            repeat
                                if LotRestriction.Get(ProdOrder."Co-Man No.", ConItemLedgerEntry."Item No.", ConItemLedgerEntry."Variant Code", ConItemLedgerEntry."Lot No.") then begin
