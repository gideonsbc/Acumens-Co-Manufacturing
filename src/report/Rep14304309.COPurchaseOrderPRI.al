report 14304309 "CO Purchase Order PRI"
{
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CreatedByUserID; "Purchase Header".WCSystemCreatedBy)
                    {
                    }
                    ...
                    column(CreatedByUserName; "Purchase Header".WCSystemCreatedBy)
                    {
                    }
                    dataitem("Purchase Line"; "Purchase Line")
                    {
                        ...
                        DataItemTableView = SORTING("Document Type", "Document No.", "Line No.") WHERE("Document Type" = CONST(Order), "PO BOM" = const(false));
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './Report RDLC/NewPurchaseOrder.rdlc';
        }
        layout(POReceiver)
        {
            Type = RDLC;
            LayoutFile = './Report RDLC/POReceiver.rdlc';
        }
    }
    labels
    {
